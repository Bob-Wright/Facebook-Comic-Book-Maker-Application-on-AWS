...
$logoutMsg .= '<title>No Share exit</title><br>'; 
$logoutMsg .= '</head><br>'; 
$logoutMsg .= '<body><br>'; 
$logoutMsg .= '<div id="Share"><br>'; 
$logoutMsg .= '<h1>User did not "Share" the image to Facebook.<br> Logging off Facebook and returning to Comics home.</h1>';
$logoutMsg .= '</div><br>'; 
$logoutMsg .= '</html>';
?>
