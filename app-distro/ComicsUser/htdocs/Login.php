...
if(isset($accessToken)){
    ...
    if(!empty($userData)){
        ...
        $output .= '<div id="profileHdr"><span><img id="profilePic" src="'.$userData['picture'].'"></span><span id="profileTitl"><h2>Profile Data Details</h2></span></div>';
        ...
        $output .= '<b>User IP:</b> '.$userData['link'].'<br>';
        ...
        $output .= '</div>';
        $output .= '<div id="FBlogoutButton"><a href="'.$logoutURL.'"><img src="../ComicsUser/Images/facebook-logout-button.png"></a></div>';
        $output .= '</div>';
    ...
    $FBloginButton = '<a href='.htmlspecialchars($loginURL).'><img id="loginButton" src="./ComicsUser/Images/facebook-sign-in-button.png"></a>';
